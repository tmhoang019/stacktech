...
const Home:React.FC = () => {
    ...
    const { data: listAlbum, error, isLoading } = useSWR(apiAlbum, getData, {
                    ...
                    return (  
                        ...
                        <Grid item xs={12} sm={6} md={4} key={item.id}>
                            ...
                            >
                                ...
                                <Link to={href} className='flex-1 overflow-hidden'>
                                    <Typography variant='h5' className='hover:text-[#2367FF] truncate'>{item.title}</Typography>
                                </Link>
                ...
                (
                    <Grid item xs={12} sm={12} md={12}>
                        <Box className='mb-10 w-full'>
                            <Typography>There are no products matching the searched keywords</Typography>
                        </Box>
                    </Grid>
                ) 
            }
